...
internal static class HttpExtensions
{
	...
	/// </summary>
	/// <remarks>
	/// The first two are this API's own authentication scheme, and they are the reason a list copied
	/// from a sibling package would not have fixed this one. Datadog does not use an Authorization
	/// header: it authenticates with <c>DD-API-KEY</c> and, for most endpoints,
	/// <c>DD-APPLICATION-KEY</c>. Neither key expires, so an exposed pair stays usable until it is
	/// revoked.
	/// </remarks>
